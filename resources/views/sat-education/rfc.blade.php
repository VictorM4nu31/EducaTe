<x-layouts::app title="Mi RFC - Educación Fiscal">
    <div class="container mx-auto py-6 max-w-4xl">
        ...
        <flux:card class="mb-6">
            <div
                class="text-center py-8 bg-linear-to-r from-emerald-50 to-blue-50 dark:from-emerald-900/20 dark:to-blue-900/20 rounded-xl">
                <p class="text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">Tu RFC Simulado</p>
                <code
                    class="text-5xl font-mono font-bold text-emerald-600 dark:text-emerald-400 tracking-wider">{{ $userRfc }}</code>
                    ...
                    <div class="p-4 border-l-4 border-emerald-500 bg-emerald-50/50 dark:bg-emerald-900/10 rounded-r-lg">
                        <div class="flex items-start justify-between mb-2">
                            <div>
                                ...
                                <code
                                    class="text-2xl font-mono font-bold text-emerald-600 dark:text-emerald-400 mt-1 block">
                                        {{ $part['value'] }}
                                    </code>
                            </div>
                            <div
                                class="px-3 py-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 rounded text-xs font-bold">
                                {{ strtoupper($key) }}
                            </div>
                        </div>
        ...
        <flux:card>
            ...
            <div class="overflow-x-auto">
                <div class="inline-flex items-center gap-2 text-2xl font-mono font-bold">
                    ...
                    @endphp
                    <span
                        class="px-3 py-2 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 rounded"
                        title="Iniciales">{{ $initials }}</span>
                    <span class="text-neutral-400">+</span>
                    <span class="px-3 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded"
                        title="Fecha">{{ $date }}</span>
                    <span class="text-neutral-400">+</span>
                    <span
                        class="px-3 py-2 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded"
                        title="Homoclave">{{ $homoclave }}</span>
                </div>
            </div>
