        ...
        <div
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                ...
                <div class="bg-white/40 backdrop-blur-md px-4 py-2 rounded-xl border border-white/50 text-center">
                    ...
                    <p class="text-2xl font-bold text-black">{{ $attempt->hints_used }} / 3</p>
                </div>
            </div>
                ...
                <flux:card>
                    ...
                    <div class="space-y-2">
                        ...
                        @elseif($question->type === 'true_false')
                            <label
                                class="flex items-center gap-3 p-3 rounded-lg border border-neutral-200 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-800 cursor-pointer transition-colors">
