...
<div class="space-y-6">
    ...
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-aulachain-green to-aulachain-green-active p-8 shadow-xl text-white">
        <div class="relative z-10">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                <div>
                    <p class="text-sm font-medium text-emerald-100 uppercase tracking-wider mb-1">Banco Virtual AulaChain</p>
        ...
        <flux:card class="p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-blue-600 dark:text-blue-400">₳ {{ number_format($weeklyAverage, 2) }}</p>
                </div>
    ...
    <flux:card>
        <div class="mb-4">
            ...
            <p class="text-sm text-neutral-500 dark:text-neutral-400">Comparativa visual de ingresos y gastos diarios</p>
        </div>
                    ...
                    <div class="p-4 flex items-center justify-between hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors">
                        <div class="flex items-center gap-4 flex-1">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-semibold text-neutral-800 dark:text-neutral-200 truncate">{{ $tx->description }}</p>
            ...
            <flux:card>
                ...
                <div class="space-y-4">
                    <div class="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                        ...
                        <p class="text-lg font-bold text-blue-900 dark:text-blue-200">₳ {{ number_format($projection4Weeks, 2) }}</p>
                        <p class="text-[10px] text-blue-600 dark:text-blue-400 mt-1">+₳ {{ number_format($projection4Weeks - $balance, 2) }} estimado</p>
                    </div>
                    <div class="p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                        ...
                        <p class="text-lg font-bold text-purple-900 dark:text-purple-200">₳ {{ number_format($projection8Weeks, 2) }}</p>
                        <p class="text-[10px] text-purple-600 dark:text-purple-400 mt-1">+₳ {{ number_format($projection8Weeks - $balance, 2) }} estimado</p>
                    </div>
                </div>
            </flux:card>
                    ...
                    @forelse($savingsGoals as $goal)
                        <div class="p-3 bg-neutral-50 dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                @if($goal->isNearGoal())
                                    <span class="px-2 py-0.5 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 rounded text-xs font-bold">
                                        ¡Cerca!
                                    </span>
                                @endif
                            </div>
                            <div class="w-full bg-neutral-200 dark:bg-neutral-700 rounded-full h-2 mb-2">
                                <div 
                                    class="bg-emerald-500 rounded-full h-2 transition-all duration-500"
