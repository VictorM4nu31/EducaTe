...
<body class="min-h-screen bg-white dark:bg-neutral-dark">
    <flux:header container
        class="border-b border-neutral-light bg-aulachain-blue text-white dark:border-neutral-light dark:bg-aulachain-blue">
    ...
    <flux:sidebar collapsible="mobile" sticky
        class="lg:hidden border-e border-neutral-light bg-neutral-very-light dark:border-neutral-light dark:bg-neutral-very-light">
        <flux:sidebar.header>
