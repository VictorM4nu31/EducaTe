        ...
        <div class="space-y-4">
            ...
            <div class="space-y-4">
                @forelse($group->tasks as $task)
                    <div class="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-5 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6 hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors">
                        <!-- Task Info Columns -->
                        <div class="flex-1 grid grid-cols-2 md:grid-cols-4 gap-6">
                            <!-- Title -->
                            <div class="flex flex-col">
                                <span class="text-xs text-neutral-500 mb-1">Tarea</span>
                                <span class="font-bold text-neutral-900 dark:text-neutral-100 truncate" title="{{ $task->title }}">
                                    {{ $task->title }}
                                </span>
                            </div>
                        ...
                        <div class="flex items-center gap-3 pt-4 md:pt-0 border-t md:border-t-0 border-neutral-100 dark:border-neutral-800">
                            <flux:button href="{{ route('teacher.tasks.submissions') }}" 
                                variant="outline" 
                ...
                @empty
                    <div class="text-center py-8 bg-neutral-50 dark:bg-neutral-900/50 rounded-xl border border-dashed border-neutral-200 dark:border-neutral-800">
                    ...
                    <div class="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-5 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6 hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors">
                        ...
                        <div class="flex-1 grid grid-cols-2 md:grid-cols-4 gap-6">
                            ...
                            <div class="flex flex-col">
                                <span class="text-xs text-neutral-500 mb-1">Dificultad</span>
                                <div>
                                    <flux:badge size="sm" class="bg-neutral-100 text-neutral-600 border border-neutral-200 dark:bg-neutral-800 dark:text-neutral-400 dark:border-neutral-700">
                                        {{ ucfirst($task->difficulty) }}
                                    </flux:badge>
                                </div>
                            </div>
